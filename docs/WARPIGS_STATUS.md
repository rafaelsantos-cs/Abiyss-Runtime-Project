...
This file is updated as adversarial rounds progress.

- Normal runtime suite: previously validated at 68 tests.
- WarPigs regression suite: 20 initial adversarial checks committed.
